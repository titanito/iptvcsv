### EXPORTA LISTA M3U A ARCHIVO PLANO CSV ###
...
with open(archivo_m3u, "r") as f:
    for linea in f:
        ...
        if linea.startswith("#EXTINF:"):
            ...
            datos.append([valor_final,group_title, tvg_logo, tvg_id, url])
